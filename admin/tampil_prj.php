    ...
    while ($row = mysql_fetch_array($resultselect)) {
        ...
        <tr>
            ...
            <td><?php
                ...
                ?> </td>
            <td><?php echo "<a class='btn btn-info btn-sm' href='admin.php?view=tampil_ubah_prj&no_rj=" . $row['no_rj'] . "'><i class='glyphicon glyphicon-edit'></i></a> | 
...
<script type="text/javascript">
    $(document).ready(function () {
        $("button#submit").click(function () {
            $.ajax({
                type: "POST",
                url: "admin/aksi_tambah_prj.php",
                data: $('form#tambah_prj').serialize(),
                success: function (msg) {
                    $("#tambahModal").modal('hide')
                    location.href = 'admin.php?view=tampil_prj';
                    ;
                },
                error: function () {
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        $("#departemen").change(function (event) {
            ...
            $.ajax({
                url: 'admin/aksi_lihat_tarif_rj.php?departemen=' + selectvalue,
