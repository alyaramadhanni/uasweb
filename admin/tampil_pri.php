    ...
    while ($row = mysql_fetch_array($resultselect)) {
        ...
        <tr>
            ...
            <td><?php
                ...
                ?> </td>
            <td><?php echo "<a class='btn btn-info btn-sm' href='admin.php?view=tampil_ubah_pri&no_ri=" . $row['no_ri'] . "'><i class='glyphicon glyphicon-edit'></i></a> | 
                    <a class='btn btn-danger btn-sm' href='admin.php?view=aksi_hapus_pri&no_ri=" . $row['no_ri'] . "' onclick='return confirm(&quot;Apakah anda yakin akan menghapus data pasien rawat inap tersebut?&quot;)'><i class='glyphicon glyphicon-trash'></i></a>";
                ?></td>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        $("#btn_cek_tarif").click(function () {
            ...
            $.ajax({
                url: 'admin/aksi_lihat_tarif_ri.php?pelayanan=' + pelayanan +
