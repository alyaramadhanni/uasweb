...
<tbody>
    <?php
    $query = "SELECT r.id_resep, p.nama_pasien, r.nama_resep, r.rincian_resep, d.nama_dokter from tbl_resep r left join tbl_pasien p on r.id_pasien = p.id_pasien left join tbl_dokter d on r.id_dokter = d.id_user ";
    ...
    <i class="glyphicon glyphicon-edit"></i> Ubah</button> <a class="btn btn-danger btn-sm" href="admin/aksi_hapus_resep.php?id_resep=' . $row['id_resep'] . '"><i class="glyphicon glyphicon-trash"></i>  Hapus </a>';
            ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="tambah_pasien" id="tambah_pasien" method="POST" action="admin/aksi_tambah_resep.php">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="ubah_resep" id="ubah_resep" method="POST" action="admin/aksi_ubah_resep.php">
                    <div class="input-group input-lg">
                        <span class="input-group-addon">
                            <i class="glyphicon glyphicon-user"></i>
                        </span>
